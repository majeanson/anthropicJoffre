...
export const RATE_LIMITS: Record<string, RateLimitConfig> = {
  ...
  // Gameplay Actions (per socket - need to be responsive)
  place_bet: {
    windowMs: 60 * 1000, // 1 minute
    maxRequests: 30, // Allow multiple bets across rounds
    message: 'Too many betting actions. Please wait.',
  },

  play_card: {
    windowMs: 60 * 1000, // 1 minute
    maxRequests: 50, // Allow multiple card plays
  ...
  reconnect_to_game: {
    windowMs: 60 * 1000, // 1 minute
    maxRequests: 20, // Allow multiple reconnection attempts
...
export const GLOBAL_RATE_LIMIT: RateLimitConfig = {
  windowMs: 60 * 1000, // 1 minute
  maxRequests: 200, // 200 total actions per minute per socket
