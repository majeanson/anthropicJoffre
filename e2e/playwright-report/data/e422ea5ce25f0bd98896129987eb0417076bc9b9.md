  ...
  - generic [ref=e55]:
    ...
    - generic [ref=e57]:
      ...
      - button "5" [disabled] [ref=e60]:
        - generic [ref=e61]: "5"
      - button "0 +5" [disabled] [ref=e62]:
        - generic [ref=e63]: "0"
        - generic [ref=e64]: "+5"
      - button "1" [disabled] [ref=e65]:
        - generic [ref=e66]: "1"
      - button "0" [disabled] [ref=e67]:
        - generic [ref=e68]: "0"
      - button "2" [disabled] [ref=e69]:
        - generic [ref=e70]: "2"
      - button "4" [disabled] [ref=e71]:
        - generic [ref=e72]: "4"
    - paragraph [ref=e73]: Waiting for other players...
```