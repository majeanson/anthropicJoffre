...
const teamColors: Record<TeamId, {
  solid: string;
  subtle: string;
  outlined: string;
  selectedRing: string;
  ...
  1: {
    ...
    subtle: 'bg-orange-100/50 dark:bg-orange-900/30 text-orange-900 dark:text-orange-100 border-orange-300 dark:border-orange-700',
    outlined: 'bg-transparent text-orange-700 dark:text-orange-300 border-orange-400 dark:border-orange-600',
    selectedRing: 'ring-2 ring-orange-400 dark:ring-orange-500 ring-offset-2 dark:ring-offset-gray-800',
  },
  2: {
    solid: 'bg-purple-500 dark:bg-purple-600 text-white border-purple-600 dark:border-purple-700',
    subtle: 'bg-purple-100/50 dark:bg-purple-900/30 text-purple-900 dark:text-purple-100 border-purple-300 dark:border-purple-700',
    outlined: 'bg-transparent text-purple-700 dark:text-purple-300 border-purple-400 dark:border-purple-600',
    selectedRing: 'ring-2 ring-purple-400 dark:ring-purple-500 ring-offset-2 dark:ring-offset-gray-800',
  },
};
