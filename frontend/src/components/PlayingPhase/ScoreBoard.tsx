...
export const ScoreBoard = memo(function ScoreBoard({
  ...
  const team1HasBet = gameState.highestBet &&
    gameState.players.find(p => p.id === gameState.highestBet?.playerId)?.teamId === 1;
  const team2HasBet = gameState.highestBet &&
  ...
  return (
    <div className="w-full mb-2 md:mb-4 lg:mb-6 flex-shrink-0 px-2 md:px-4 lg:px-6 pt-2 md:pt-4 lg:pt-6 overflow-visible">
      <div
        className="rounded-[var(--radius-xl)] p-2 md:p-4 lg:p-6 border-2 overflow-visible"
        style={{
      ...
      >
        <div className="flex justify-between items-center gap-2 md:gap-8">
          {/* Team 1 */}
          <div
            className="flex-1 rounded-[var(--radius-lg)] p-2 md:p-3 border-2 relative overflow-visible"
            style={{
          ...
          >
            <h3
              className="text-xs md:text-sm font-display uppercase tracking-wider mb-1 flex items-center justify-start gap-1"
              style={{ color: 'var(--color-team1-text)', opacity: 0.8 }}
            >
              <span>Team 1</span>
              {team1HasBet && (
            ...
            <p
              className="text-lg md:text-2xl font-display relative"
              style={{ color: 'var(--color-team1-text)' }}
            >
              ...
              {floatingTrickPoints.team1 !== null && (
                <span className="absolute left-1/2 -translate-x-1/2 -top-8 animate-points-float-up z-[9999]">
                  <span
                    ...
                    style={{
                      backgroundColor: floatingTrickPoints.team1 >= 0 ? 'var(--color-success)' : 'var(--color-error)',
                      borderColor: floatingTrickPoints.team1 >= 0 ? 'var(--color-success)' : 'var(--color-error)',
                    }}
                  >
            ...
            {floatingPoints.team1 !== null && (
              <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-4 animate-points-float-up z-[9999]">
                <div
                  ...
                  style={{
                    backgroundColor: floatingPoints.team1 >= 0 ? 'var(--color-success)' : 'var(--color-error)',
                    borderColor: floatingPoints.team1 >= 0 ? 'var(--color-success)' : 'var(--color-error)',
                  }}
                >
          ...
          {/* Team 2 */}
          <div
            className="flex-1 rounded-[var(--radius-lg)] p-2 md:p-3 text-right border-2 relative overflow-visible"
            style={{
          ...
          >
            <h3
              className="text-xs md:text-sm font-display uppercase tracking-wider mb-1 flex items-center justify-end gap-1"
              style={{ color: 'var(--color-team2-text)', opacity: 0.8 }}
            >
              {team2HasBet && (
                <span className="flex items-center gap-1">
                  <span className="text-base">🎲</span>
            ...
            <p
              className="text-lg md:text-2xl font-display relative"
              style={{ color: 'var(--color-team2-text)' }}
            >
              ...
              {floatingTrickPoints.team2 !== null && (
                <span className="absolute left-1/2 -translate-x-1/2 -top-8 animate-points-float-up z-[9999]">
                  <span
                    className="px-2 py-1 rounded-full font-black text-white text-xs border-2"
                    style={{
                      backgroundColor: floatingTrickPoints.team2 >= 0 ? 'var(--color-success)' : 'var(--color-error)',
                      borderColor: floatingTrickPoints.team2 >= 0 ? 'var(--color-success)' : 'var(--color-error)',
                    }}
                  >
            ...
            {floatingPoints.team2 !== null && (
              <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-4 animate-points-float-up z-[9999]">
                <div
                  className="px-3 py-1.5 rounded-full font-black text-white border-2"
                  style={{
                    backgroundColor: floatingPoints.team2 >= 0 ? 'var(--color-success)' : 'var(--color-error)',
                    borderColor: floatingPoints.team2 >= 0 ? 'var(--color-success)' : 'var(--color-error)',
                  }}
                >
                  <span className="text-base md:text-xl">
