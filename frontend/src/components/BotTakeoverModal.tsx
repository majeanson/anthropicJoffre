  ...
  return (
    ...
    >
      ...
      <div className="space-y-3">
        <h3 className="text-lg font-bold text-skin-primary mb-2">Available Bots:</h3>
            ...
            <div className="flex items-center justify-between gap-4 mb-3">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-skin-primary">{bot.name}</span>
                </div>
                <div className="text-sm text-skin-secondary mt-1">
