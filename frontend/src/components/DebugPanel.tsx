      ...
      <div className="space-y-6">
        ...
        <section aria-labelledby="game-info-heading">
          <h3
            ...
            className="text-lg font-bold text-gray-800 mb-3 border-b-2 border-purple-200 pb-2"
          >
            📋 Game Information
          </h3>
              ...
              <div className="grid grid-cols-2 gap-2">
                {gameState.currentBets.map((bet) => {
                  ...
                  return (
                    <div
                      key={bet.playerId}
                      className="flex items-center justify-between bg-parchment-50 rounded p-2 border border-parchment-400"
                    >
