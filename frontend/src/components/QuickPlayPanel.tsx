...
export function QuickPlayPanel({
  ...
  return (
    <UICard variant="bordered" size="md" className="bg-parchment-200">
      {/* Header with toggle */}
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-sm font-bold text-umber-800">
          ⚡ Quick Play with Bots
        </h3>
        <button
          onClick={toggleOptions}
          className="text-xs px-2 py-1 rounded bg-umber-100 text-umber-600 hover:bg-umber-200 transition-colors"
        >
      ...
      {!showOptions && (
        <div className="flex items-center justify-center gap-3 mb-3 text-xs text-umber-600">
      ...
      {showOptions && (
        <div className="space-y-3 mb-3 animate-slideDown">
          ...
          <div>
            <label className="block text-xs font-semibold text-umber-700 mb-2">
              Bot Difficulty
            </label>
            ...
            <p className="text-xs text-umber-600 mt-2 text-center">
          ...
          <UICard
            variant="bordered"
            size="sm"
            className={`bg-parchment-100 ${!tierInfo.canPlayRanked ? 'opacity-60' : ''}`}
          >
