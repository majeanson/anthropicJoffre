...
export function ProfileEditor({
  ...
  return (
    <div className="space-y-6">
      {/* Avatar Selection */}
      <div>
        <label className="block text-sm font-semibold text-skin-secondary mb-2">
          Avatar
        </label>
        <div className="flex items-center gap-4">
          <div className="w-20 h-20 bg-skin-secondary rounded-lg flex items-center justify-center text-6xl">
      ...
      <div>
        <label
          htmlFor="bio"
          className="block text-sm font-semibold text-skin-secondary mb-2"
        >
          Bio
        </label>
        <textarea
          ...
          maxLength={maxChars}
        />
        <div className="text-right text-xs text-skin-muted mt-1">
      ...
      {/* Action Buttons */}
      <div className="flex gap-3 pt-4 border-t border-skin-subtle">
