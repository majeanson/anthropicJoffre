...
export function GameReplay({ gameId, socket, onClose }: GameReplayProps) {
  ...
  return (
    ...
    >
      <div
        className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl md:rounded-2xl shadow-2xl max-w-6xl w-full max-h-[95vh] overflow-y-auto border-2 md:border-4 border-emerald-600"
      ...
      >
        ...
        {/* Game Info Bar */}
        <div className="bg-parchment-50 px-4 md:px-8 py-3 md:py-4 border-b-2 border-parchment-400">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
            ...
            {replayData.is_bot_game && (
              <div className="flex items-center gap-2 px-2 md:px-3 py-1 bg-blue-100 rounded-lg self-start md:self-auto">
        ...
        {currentRound && (
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 px-4 md:px-8 py-3 md:py-4">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
              <div className="flex items-center gap-4 md:gap-6 flex-wrap">
                <div>
                  <p className="text-xs text-gray-500 font-semibold">Round</p>
                ...
                {currentBet && (
                  <>
                    ...
                    <div>
                      <p className="text-xs text-gray-500 font-semibold">Bet</p>
                      <p className="text-sm md:text-lg font-bold text-gray-700">
                ...
                <div className="hidden md:block w-px h-8 bg-gray-300" />
                <div>
                  <p className="text-xs text-gray-500 font-semibold">Trick</p>
        ...
        <div className="p-4 md:p-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-8">
            ...
            <div className="lg:col-span-2">
              {/* Current Trick */}
              {currentTrick && (
                <div className="bg-parchment-50 rounded-xl p-4 md:p-6 shadow-lg mb-4 md:mb-6 border border-parchment-400">
                  <h3 className="text-lg md:text-xl font-black text-umber-800 mb-3 md:mb-4 flex flex-col md:flex-row md:items-center gap-1 md:gap-2">
                    <div className="flex items-center gap-2">
                      <span className="text-xl md:text-2xl">🎴</span>
                      <span>Current Trick</span>
                    </div>
                    {currentTrick.winnerName && (
                      <span className="md:ml-auto text-xs md:text-sm font-semibold text-green-600">
              ...
              {Object.keys(startingHands).length > 0 && (
                <div className="bg-parchment-50 rounded-xl p-4 md:p-6 shadow-lg border border-parchment-400">
                  <h3 className="text-lg md:text-xl font-black text-umber-800 mb-4 flex items-center gap-2">
                    <span className="text-xl md:text-2xl">🃏</span>
            ...
            <div className="space-y-4 md:space-y-6">
              {/* Playback Controls */}
              <div className="bg-parchment-50 rounded-xl p-4 md:p-6 shadow-lg border border-parchment-400">
                <h3 className="text-base md:text-lg font-black text-umber-800 mb-3 md:mb-4">
                  Playback Controls
                </h3>

                {/* Speed Control */}
                <div className="mb-3 md:mb-4">
                  <p className="text-xs md:text-sm text-umber-700 mb-2">
                    Speed:
                  </p>
