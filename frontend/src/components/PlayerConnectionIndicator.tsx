    ...
    <div className="flex items-center gap-2">
      ...
      <div className="flex flex-col">
        <span className={`text-sm font-medium ${text}`}>
          {playerName && <span className="text-skin-secondary">{playerName} - </span>}
          {label}
        </span>
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        {isCurrentPlayer && (
          <span className="text-xs text-skin-success">(You)</span>
        )}
        {isBot && (
      ...
      {isDisconnected && reconnectTimeLeft !== undefined && (
        <div className="mt-1 text-xs text-skin-error">
