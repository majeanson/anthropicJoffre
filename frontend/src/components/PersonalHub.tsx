    ...
    >
      {loading ? (
        <div className="text-center py-8">
          ...
          <p className="text-skin-secondary mt-4">Loading your progress...</p>
        </div>
      ) : (
        <div className="space-y-4">
                ...
                <UICard variant="bordered" size="md">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      {/* XP Progress Bar */}
                      <div className="h-3 bg-skin-tertiary rounded-full overflow-hidden">
                        <div
                  ...
                  {/* Quick Stats Row */}
                  <div className="mt-4 pt-3 border-t border-skin-subtle grid grid-cols-3 gap-2 text-center">
                    <div>
                      <div className="text-lg font-bold text-blue-500">
                        {playerStats.games_played}
                      </div>
                      <div className="text-[10px] text-skin-muted uppercase">
                        Games
                      </div>
                    </div>
                    <div>
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-skin-primary font-bold text-lg">Login Streak</h3>
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <span className="text-3xl">📋</span>
                <div>
                  <h3 className="text-skin-primary font-bold text-lg">Daily Quests</h3>
                  {questSummary ? (
                    <p className="text-skin-secondary text-sm">
                      {questSummary.completed}/{questSummary.total} completed
                      {questSummary.claimable > 0 && (
                        <span className="text-skin-success ml-2">
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <span className="text-3xl">📅</span>
                <div>
                  <h3 className="text-skin-primary font-bold text-lg">
                    30-Day Rewards
                  </h3>
                  {calendarSummary ? (
                    <p className="text-skin-secondary text-sm">
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <span className="text-3xl">🏆</span>
                <div>
                  <h3 className="text-skin-primary font-bold text-lg">Achievements</h3>
                  <p className="text-skin-secondary text-sm">
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <span className="text-3xl">👤</span>
                <div>
                  <h3 className="text-skin-primary font-bold text-lg">My Profile</h3>
                  <p className="text-skin-secondary text-sm">View stats & customize</p>
                </div>
              </div>
              <Button variant="ghost" size="sm">
                View →
          ...
          {questSummary && questSummary.completed < questSummary.total && (
            <div className="mt-6 pt-4 border-t border-skin-default">
