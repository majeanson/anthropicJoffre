    ...
    <div
      className={`grid grid-cols-1 md:grid-cols-7 gap-2 md:gap-4 p-4 rounded-lg transition-all duration-200 ${
        index < 3
          ...
          : 'bg-parchment-50 hover:bg-parchment-100 border border-parchment-400'
      } ${onViewPlayerStats ? 'cursor-pointer hover:scale-[1.02]' : ''}`}
      onClick={() => onViewPlayerStats?.(player.player_name)}
    >
      {/* Rank */}
      <div className="col-span-1 flex items-center">
        <span className="text-2xl md:text-3xl font-bold text-umber-800">
      ...
      <div className="col-span-1 md:col-span-2 flex flex-col justify-center">
        <p className="font-bold text-lg text-umber-900">{player.player_name}</p>
      ...
      {!showRoundStats ? (
        <>
          ...
          <div className="col-span-1 flex flex-col items-center justify-center">
            <p className="text-sm text-gray-600 md:hidden">ELO</p>
          ...
          {/* Games Played */}
          <div className="col-span-1 flex flex-col items-center justify-center">
            <p className="text-sm text-gray-600 md:hidden">Games</p>
          ...
          {/* Win Percentage */}
          <div className="col-span-1 flex flex-col items-center justify-center">
            <p className="text-sm text-gray-600 md:hidden">Win Rate</p>
        ...
        <>
          {/* Total Rounds Played */}
          <div className="col-span-1 flex flex-col items-center justify-center">
            <p className="text-sm text-blue-600 md:hidden">Rounds</p>
          ...
          <div className="col-span-1 flex flex-col items-center justify-center">
            <p className="text-sm text-blue-600 md:hidden">Round Win%</p>
            <p className="text-xl font-bold text-green-600">
          ...
          <div className="col-span-1 flex flex-col items-center justify-center">
            <p className="text-sm text-blue-600 md:hidden">Avg Tricks</p>
          ...
          {/* Bet Success Rate */}
          <div className="col-span-1 flex flex-col items-center justify-center">
            <p className="text-sm text-blue-600 md:hidden">Bet Success</p>
      ...
      <div className="space-y-4">
        ...
        {!loading && players.length > 0 && (
          <div className="space-y-4">
            ...
            {!showRoundStats && (
              <div className="hidden md:grid md:grid-cols-7 gap-4 px-4 py-3 bg-gray-200 rounded-lg font-bold text-sm text-gray-700">
            ...
            {showRoundStats && (
              <div className="hidden md:grid md:grid-cols-7 gap-4 px-4 py-3 bg-blue-200 rounded-lg font-bold text-sm text-blue-900">
                <div className="col-span-1">Rank</div>
                <div className="col-span-2">Player</div>
