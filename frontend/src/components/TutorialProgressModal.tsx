  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
        {/* Completion Message */}
        {stats.allCompleted && (
          <div className="mb-4 bg-skin-success border-2 border-skin-success rounded-lg p-4">
            <p className="text-skin-inverse font-bold text-center">
              ...
              >
                ...
                {isExpanded && (
                  <div className="px-3 pb-3 pt-0 border-t border-skin-default">
                    <div className="mt-3 p-3 bg-skin-info rounded-lg border border-skin-info">
                      <div className="flex items-center gap-2 mb-2">
                        <span className="text-xl">{TUTORIAL_ICONS[phase]}</span>
                        <span className="text-skin-inverse font-bold text-sm">
                          {TUTORIAL_TITLES[phase]}
                        </span>
                      </div>
                      <p className="text-skin-inverse text-sm whitespace-pre-line leading-relaxed">
        ...
        {/* Help Text */}
        {!stats.allCompleted && (
          <div className="mt-6 bg-skin-info rounded-lg p-4">
            <p className="text-sm text-skin-inverse">
